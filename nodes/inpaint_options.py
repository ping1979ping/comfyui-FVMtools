    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "reference_1_mask_type": (["face", "head", "body", "hair", "facial_skin", "eyes", "mouth", "neck", "accessories"], {"default": "head", "tooltip": "Mask type for reference slot 1"}),
                "reference_2_mask_type": (["face", "head", "body", "hair", "facial_skin", "eyes", "mouth", "neck", "accessories"], {"default": "head", "tooltip": "Mask type for reference slot 2"}),
                "reference_3_mask_type": (["face", "head", "body", "hair", "facial_skin", "eyes", "mouth", "neck", "accessories"], {"default": "head", "tooltip": "Mask type for reference slot 3"}),
                "reference_4_mask_type": (["face", "head", "body", "hair", "facial_skin", "eyes", "mouth", "neck", "accessories"], {"default": "head", "tooltip": "Mask type for reference slot 4"}),
                "reference_5_mask_type": (["face", "head", "body", "hair", "facial_skin", "eyes", "mouth", "neck", "accessories"], {"default": "head", "tooltip": "Mask type for reference slot 5"}),
                "generic_mask_type": (["face", "head", "body", "hair", "facial_skin", "eyes", "mouth", "neck", "accessories"], {"default": "head", "tooltip": "Mask type for generic (unmatched) slot"}),
